// Shared mock-fetch/env helper for lib/razorpay/*.test.ts and
// app/checkout/*.test.ts files. Not itself a test — deliberately named
// without a .test. suffix so Node's test runner glob doesn't execute it
// directly. Mirrors lib/shiprocket/test-helpers.ts exactly.
